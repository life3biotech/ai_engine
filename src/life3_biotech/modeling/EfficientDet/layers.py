...
class FilterDetections(keras.layers.Layer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.nms = const.INFERENCE_RUN_NMS
        self.class_specific_filter = const.CLASS_SPECIFIC_FILTER
        self.nms_threshold = const.INFERENCE_NMS_THRESH
        self.score_threshold = score_threshold
        self.max_detections = const.MAX_DETECTIONS
        self.parallel_iterations = parallel_iterations
        self.detect_quadrangle = const.DETECT_QUADRANGLE
        self.select_top_k = const.SELECT_TOP_K
