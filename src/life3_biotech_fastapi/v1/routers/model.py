...
PRED_MODEL = life3_fapi.deps.PRED_MODEL


@ROUTER.post("/predict", status_code=fastapi.status.HTTP_200_OK)
def predict_sentiment(movie_reviews_json: life3_fapi.schemas.MovieReviews):
    """Endpoint that returns sentiment classification of movie review
    texts.

    Parameters
    ----------
    movie_reviews_json : life3_fapi.schemas.MovieReviews
...
def get_model_version():
    ...
    dict
        ...
        served.
    """
    return {"data": {"model_uuid": life3_fapi.config.SETTINGS.PRED_MODEL_UUID}}
