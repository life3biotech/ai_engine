...
ARG CONDA_ENV_NAME="life3-biotech-infer"
...
ARG PRED_MODEL_GCS_URI="gs://life3-biotech-artifacts/mlflow-tracking-server/$PRED_MODEL_UUID"
...
WORKDIR $HOME_DIR/life3-biotech
